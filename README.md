...
|-|------|------------|----------------|--------------|----|
|1.|[Исследование надёжности заёмщиков](001_investigation_of_the_reliability_of_borrowers)|Предобработка данных|Заказчик — кредитный отдел банка. Входные данные от банка — статистика о платёжеспособности клиентов. Результаты исследования будут учтены при построении модели кредитного скоринга.|Определить, как влияет семейное положение и количество детей клиента на факт погашения кредита в срок.|`pandas`, `numpy`, `matplotlib`, `seaborn`|
